  ...
  return (
    <div className="bg-background min-h-screen flex flex-col items-center gap-5">
      ...
      <h2 className="text-center mx-3">
        Acompanhe cada batida, avalie cada detalhe e compartilhe suas opiniões
        mais sinceras.
      </h2>
      ...
      >
        <Button
          size="lg"
          className="flex items-center gap-2 text-lg rounded-full"
          onClick={redirect}
        >
          Comece a avaliar <ArrowRight />
        </Button>
      </motion.div>
      ...
      <Card className="w-[90%] md:max-w-[500px] mx-3 gap-0 rounded-4xl border-0 overflow-hidden pb-0">
        ...
        <CardContent>
          <p>
            Compartilhe suas avaliações em outras redes com o nosso template de
            review.
          </p>
          <motion.div
      ...
      <Card className="w-[90%] md:max-w-[500px] mx-3 gap-0 bg-linear-to-b from-primary to-indigo-900 rounded-4xl border-0 overflow-hidden">
        <CardHeader className="text-2xl font-bold">Conecte-se</CardHeader>
        <CardContent>
          ...
          <div className="space-y-2 mt-3">
            {[1, 2, 3].map((i) => (
              <motion.div
                ...
                key={i}
                className="bg-white/10 backdrop-blur-md p-3 rounded-xl flex items-center gap-3 border border-white/10 transform group-hover:translate-y-[-5px] transition-transform"
              >
      ...
      <div className="mx-2 text-center text-2xl space-y-2">
        <p className="">
          Pesquise por <b> albuns</b>, <b>musicas</b> ou <b>artistas</b>:{" "}
        </p>
